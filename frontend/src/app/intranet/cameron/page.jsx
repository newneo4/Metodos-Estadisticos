...
const CameronPage = () => {
  ...
  // Función para calcular el Método de Cameron
  const calculateCameronMethod = () => {
    ...
    // Ejemplo de cálculos ficticios para el Método de Cameron
  ...
  return (
    <div className="p-4">
      <h1 className="text-2xl font-bold mb-4">Método de Cameron</h1>
      <input 
        type="file" 
        accept='.xlsx, .xls'
      ...
      {data.length > 0 && (
        <div>
          ...
          {results && (
            <div className="mt-4">
              {/* Resultados */}
              <h2 className="text-xl font-bold mb-2">Resultados del Método de Cameron:</h2>
